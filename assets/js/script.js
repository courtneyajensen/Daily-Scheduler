// Obtain current day using moment.js
...
// Generates timeblocks and inserts saved data from local storage
...
var auditTime = function () {
    ...
    if (moment().isBetween(hour16, hour17)) {
     ...
     if (moment().isBetween(hour17, hour17)) {
